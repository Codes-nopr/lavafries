...
import Manager from "./ClientRefactor";
import Node from "./NodeRefactor";
...
export default class Player<T = unknown> {
    ...
    public constructor(lavafries: Manager, options: any | any[], queueOption?: any, node?: Node) {
    ...
    public friesSearch(query: string, user: any, options: { source?: "yt" | "sc"; add?: boolean }): Promise<any[] | any | any[]> {
